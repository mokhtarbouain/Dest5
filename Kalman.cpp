...
class KalmanFilter2D:
    ...
    def update(self, measurement):
        ...
        innovation = np.array([measurement.x - self.state[0], measurement.y - self.state[1]])
        self.state += np.array([self.kalman_gain[0, 0] * innovation[0], self.kalman_gain[1, 1] * innovation[1]])
